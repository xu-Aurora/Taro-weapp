          ...
          datas.State != 6 && (
            <View className="footer1">
              <View onClick={this.backBuy.bind(this, datas)}>
                <AtButton type="primary" size="small" loading={disabled}>
                  申请回购
                </AtButton>
              </View>
            </View>
        ...
        {datas.State == 6 && (
          <View className="footer1">
            <View onClick={this.cancel.bind(this, datas.ParkingId)}>
              <AtButton loading={disabled1} type="primary" size="small">
                取消回购
              </AtButton>
            </View>
          </View>
