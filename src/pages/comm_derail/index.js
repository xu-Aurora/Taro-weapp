...
import { imgUrl, isEmpty, splitThousand, changeNum } from "../../utils/util";
  ...
  renderParkingTraitType(data) {
    return (
      ...
      data.split(",").map((item, i) => {
        return (
          <Text key={item + i} className="tag_blue">
            {item}
          </Text>
        );
      })
        ...
        >
          <View className="top_title">
            <View>
              ...
              <Text
                onClick={this.goPage.bind(this, "c_detail", datas.BuildingId)}
              >
                仓储详情
              </Text>
            </View>
                  ...
                  >
                            ...
                            >
                              ...
                              <View className="right">
                                ...
                                <View>
                                  ...
                                  ：{ele.Price && splitThousand(ele.Price)}
                                </View>
                              </View>
                            </View>
                          );
                    ...
                    {isEmpty(datas.List.rows) && (
                      <View
                        className="nodata"
                        style={{
                          height: `calc(100vh - ${surHeight + 20}rpx)`,
                          marginRight: "32rpx"
                        }}
                      >
                        <View>
